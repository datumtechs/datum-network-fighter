...
class Evaluator:
    ...
    def run(self):
        ...
        else:  # compute node for evaluation
            import evaluate
            evaluate.start(self.all_cfg, self.io_channel)
    ...
    def handle_result_party(self, remote_nodeid, recved: bytes, cfg):
        ...
        try:
            ...
            if c == b'upload_model_cfg':
                ...
                _ = recved[:sep]
                recved = recved[sep + 1:]
                path = cfg.resource.model_best_config_path
                ...
                path = cfg.resource.model_best_weight_path
...
def main(channel_config: str, cfg_dict: dict, data_party: list, result_party: list, results_dir: str, **kwargs):
    ...
    eva = Evaluator(channel_config, cfg_dict, data_party, result_party, results_dir, kwargs)
    eva.run()
