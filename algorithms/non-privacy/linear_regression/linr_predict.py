...
class LinRPredict(BaseAlgorithm):
    '''
    Plaintext linear regression predict.
    '''
...
@ErrorTraceback("non-privacy_linr_predict")
def main(io_channel, cfg_dict: dict, data_party: list, compute_party: list, result_party: list, results_dir: str, **kwargs):
    '''
    This is the entrance to this module
    '''
    linr = LinRPredict(io_channel, cfg_dict, data_party, compute_party, result_party, results_dir)
    result_path, result_type = linr.predict()
    return result_path, result_type
