...
DATA_EVENT = {
    ...
    "DOWNLOAD_ALGORITHM_SUCCESS": "0209001",  # 下载合约代码成功
    "DOWNLOAD_ALGORITHM_FAILED": "0209002",  # 下载合约代码失败
    ...
    "ALGORITHM_EXECUTE_START": "0209011",  # 开始执行合约
    "ALGORITHM_EXECUTE_SUCCESS": "0209012",  # 合约执行成功
    "ALGORITHM_EXECUTE_FAILED": "0209013",  # 合约执行失败
    "RESOURCE_LIMIT_FAILED": "0209014"     # 使用资源超过限制失败
}

COMPUTE_EVENT = {
    "TASK_START": "0309000",  # 开始新任务
    "DOWNLOAD_ALGORITHM_SUCCESS": "0309001",  # 下载合约代码成功
    "DOWNLOAD_ALGORITHM_FAILED": "0309002",  # 下载合约代码失败
    ...
    "ALGORITHM_EXECUTE_START": "0309011",  # 开始执行合约
    "ALGORITHM_EXECUTE_SUCCESS": "0309012",  # 合约执行成功
    "ALGORITHM_EXECUTE_FAILED": "0309013",  # 合约执行失败
