...
_UPLOADREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='meta', full_name='datasvc.UploadRequest.meta', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='data', full_name='datasvc.UploadRequest.data',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_UPLOADREQUEST.fields_by_name['meta'].message_type = _FILEINFO
_UPLOADREQUEST.oneofs_by_name['data'].fields.append(
  _UPLOADREQUEST.fields_by_name['meta'])
_UPLOADREQUEST.fields_by_name['meta'].containing_oneof = _UPLOADREQUEST.oneofs_by_name['data']
_UPLOADREQUEST.oneofs_by_name['data'].fields.append(
  _UPLOADREQUEST.fields_by_name['content'])
_UPLOADREQUEST.fields_by_name['content'].containing_oneof = _UPLOADREQUEST.oneofs_by_name['data']
